...
public class DetailAdapter extends RecyclerView.Adapter<DetailAdapter.MyViewHolder> {
    ...
    public DetailAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View view= LayoutInflater.from(context).inflate(R.layout.activity_goods_detail,parent,false);
    ...
    public void onBindViewHolder(final MyViewHolder holder,final int position){
        ...
        fundescrib fun=new fundescrib(context,ss);
        ...
        switch (Nam){
            case "Enchated Forest":
                holder.iv.setImageResource(R.mipmap.enchatedforest);
                break;
            case "Arla Milk":
                holder.iv.setImageResource(R.mipmap.arla);
                break;
            case "Devondale Milk":
                holder.iv.setImageResource(R.mipmap.devondale);
                break;
            case "Kindle Oasis":
                holder.iv.setImageResource(R.mipmap.kindle);
                break;
            case "waitrose 早餐麦片":
                holder.iv.setImageResource(R.mipmap.waitrose);
                break;
            case "Mcvitie's 饼干":
                holder.iv.setImageResource(R.mipmap.mcvitie);
                break;
            case "Ferrero Rocher":
                holder.iv.setImageResource(R.mipmap.ferrero);
                break;
            case "Maltesers":
                holder.iv.setImageResource(R.mipmap.maltesers);
                break;
            case "Lindt":
                holder.iv.setImageResource(R.mipmap.lindt);
                break;
            case "Borggreve":
                holder.iv.setImageResource(R.mipmap.borggreve);
                break;
        }
    }
